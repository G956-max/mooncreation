...
export default function Login() {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center bg-[#FAF9F6] px-4 py-6 md:py-12">
      <div className="max-w-md w-full bg-white p-5 md:p-8 rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div className="text-center mb-4 md:mb-8">
          <AnimatePresence mode="wait">
            ...
            >
              <h2 className="text-xl md:text-3xl font-serif font-bold text-[#2C2C2C]">
