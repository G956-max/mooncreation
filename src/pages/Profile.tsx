  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm p-4 md:p-8">
      <div className="flex justify-between items-start mb-8">
        <div>
          <h2 className="text-lg md:text-2xl font-bold text-gray-900">My Profile</h2>
...
function OrdersTab() {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm p-4 md:p-8">
      <h2 className="text-lg md:text-2xl font-bold text-gray-900 mb-4 md:mb-6">My Orders</h2>
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm p-4 md:p-8">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-lg md:text-2xl font-bold text-gray-900">Wishlist</h2>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-3 md:gap-6">
        {wishlistItems.map((item) => (
          <div key={item.id} className="group relative border border-gray-100 rounded-xl overflow-hidden hover:shadow-lg transition-all duration-300 bg-white">
            <div className="aspect-w-1 aspect-h-1 w-full overflow-hidden bg-gray-200">
              <img
                src={item.image}
                alt={item.name}
                className="h-32 md:h-48 w-full object-cover object-center group-hover:scale-105 transition-transform duration-500"
              />
            ...
            <div className="p-2 md:p-4">
              <p className="text-[9px] md:text-xs font-medium text-gray-500 mb-1 uppercase tracking-wider">{item.category}</p>
              <h3 className="text-xs md:text-sm font-semibold text-gray-900 mb-1.5 md:mb-2 truncate">{item.name}</h3>
              <div className="flex items-center justify-between">
                <p className="text-xs md:text-sm font-bold text-gray-900">{item.price}</p>
                <button className="text-[10px] md:text-xs font-medium bg-gray-900 text-white px-2 py-1 md:px-3 md:py-1.5 rounded-lg hover:bg-gray-800 transition-colors">
                  Add to Cart
                </button>
              </div>
            </div>
...
function SettingsTab() {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm p-4 md:p-8">
      <h2 className="text-lg md:text-2xl font-bold text-gray-900 mb-4 md:mb-8">Account Settings</h2>
