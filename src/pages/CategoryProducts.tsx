...
export default function CategoryProducts() {
  ...
  const priceRanges = ['All', '₹500 - ₹1000', '₹1000 - ₹2500', '₹2500 - ₹5000'];
    ...
    <div className="pt-16 pb-12 md:pt-20 md:pb-16 min-h-screen bg-[#FAF9F6]">
      <section className="w-full px-4 sm:px-6 lg:px-8">
        ...
        {subcategories.length > 0 && (
          <div className="mb-6 md:mb-10 flex flex-wrap gap-2 md:gap-3">
            <button
        ...
        {/* Price Range Filter */}
        <div className="mb-6 md:mb-10 flex flex-wrap items-center gap-2 md:gap-3">
          <span className="py-2 text-[10px] md:text-sm font-bold text-gray-500 uppercase tracking-widest mr-1 md:mr-2">Price:</span>
            ...
            <button
              ...
              className={`px-4 py-1.5 md:px-6 md:py-2 rounded-full text-xs md:text-sm font-medium transition-all ${
                selectedPriceRange === range
                  ? 'bg-[#C48B22] text-white shadow-lg'
                  : 'bg-white text-gray-600 border border-gray-200 hover:border-[#C48B22]'
              }`}
            >
              {range}
            </button>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-8">
            {products
              ...
              .filter(p => {
                ...
                if (selectedPriceRange === '₹2500 - ₹5000') return p.price > 2500 && p.price <= 5000;
                return true;
              })
              .map((product) => (
                <Link 
