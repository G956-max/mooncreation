...
import PhotoFrameDetail from './pages/PhotoFrameDetail';
import CustomChocolateDetail from './pages/CustomChocolateDetail';
        ...
        <AuthProvider>
          <StoreProvider>
            ...
            <HashRouter>
              ...
              <Route path="/offer/:offerCode" element={<ProtectedUserRoute><OfferProducts /></ProtectedUserRoute>} />
              ...
              <Route path="/product/custom-frame" element={<ProtectedUserRoute><PhotoFrameDetail /></ProtectedUserRoute>} />
              <Route path="/product/custom-chocolate" element={<ProtectedUserRoute><CustomChocolateDetail /></ProtectedUserRoute>} />
              <Route path="/checkout" element={<ProtectedUserRoute><CheckoutLayout><Checkout /></CheckoutLayout></ProtectedUserRoute>} />
              <Route path="/order-success" element={<ProtectedUserRoute><OrderSuccess /></ProtectedUserRoute>} />
