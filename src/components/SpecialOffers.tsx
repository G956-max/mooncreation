    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="bg-[#FAF9F6] rounded-3xl overflow-hidden border border-[#C48B22]/10 shadow-sm flex flex-col md:flex-row items-center justify-between p-8 md:p-12 gap-8 relative">
        <div className="flex items-center gap-6">
          <div className="p-5 bg-white rounded-2xl shadow-sm text-[#C48B22]">
            <Gift size={40} />
          </div>
          <div>
            <h2 className="text-2xl md:text-3xl font-bold text-[#2C2C2C]">Special Offers for You!</h2>
            <p className="text-gray-500 mt-2">Grab exciting deals on top gift categories.</p>
          </div>
        </div>
        
        <div className="flex flex-col items-center md:items-end gap-2">
          <div className="bg-white px-6 py-4 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center">
            <span className="text-red-500 font-bold text-3xl">FLAT 15% OFF</span>
            <span className="text-[#2C2C2C] text-sm font-medium">On Customized Gifts</span>
          </div>
